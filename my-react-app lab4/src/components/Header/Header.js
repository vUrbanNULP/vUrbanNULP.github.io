...
function Header({ user, handleLogout, clearProgress }) {
    ...
    const handleClearProgressClick = () => {
         if (window.confirm("Ви впевнені, що хочете очистити весь прогрес тренувань? Цю дію не можна скасувати.")) {
             clearProgress();
             setIsMenuOpen(false);
         }
    };
    ...
    return (
        <header className="header">
            <div className="header-content">
                 ...
                 {user && (
                     <button ref={buttonRef} className="menu-toggle-button" onClick={toggleMenu} aria-label="Toggle menu">
